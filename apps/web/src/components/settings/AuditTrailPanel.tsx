...
const ACTION_LABEL: Record<AuditAction, string> = {
  ...
  quote_sent: 'Quote sent', quote_approved: 'Quote approved', quote_change_requested: 'Customer requested quote changes',
  upsell_accepted: 'Upsell accepted',
  order_created: 'Order created', order_status_changed: 'Order status changed', job_status_changed: 'Job status changed',
  ...
  clinical_template_created: 'Clinical note created', clinical_template_updated: 'Clinical note edited', clinical_template_finalized: 'Clinical note finalized',
}
