...
const APP_CONTAINER_CLS = 'flex items-stretch rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--muted))] px-1 transition-shadow focus-within:ring-2 focus-within:ring-accent/40 focus-within:border-accent'
